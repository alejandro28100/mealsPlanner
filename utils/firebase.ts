 ...
 */
export const setDocument = async (path: string, data: { [x: string]: any }, merge:boolean = true): Promise<void> => {
 ...
 */
export const addDocument= async (path: string, data:  {[x:string]: any}):Promise<DocumentReference>=> {
...
export const getDocuments = async (collectionPath: string, ...queryConstrains:QueryConstraint[]):Promise<QuerySnapshot<DocumentData>> => {
